...
public class LecternBrassControllerRenderer extends SafeBlockEntityRenderer<LecternBrassControllerBlockEntity> {

    public LecternBrassControllerRenderer(BlockEntityRendererProvider.Context context) {
    }

    @Override
    protected void renderSafe(LecternBrassControllerBlockEntity be, float partialTicks, PoseStack ms,
        ...
        Direction facing = be.getBlockState().getValue(LecternBrassControllerBlock.FACING);
        ...
        BrassLinkedControllerItemRenderer.renderInLectern(stack, mainModel, renderer, transformType, ms, light, active, renderDepression);
        ms.popPose();
    }
